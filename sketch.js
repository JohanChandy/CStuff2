...
function preload(){
  ...
  flappybird_img = loadImage("flappy bird.png")
  //trex_running = loadAnimation("trex_2.png","trex_1.png","trex_3.png");
  //trex_collided = loadAnimation("trex_collided.png");
  
  //groundImage = loadImage("ground.png");
  
  pipeImage = loadImage("pngkey.com-mario-pipe-png-1811759.png");
...
function setup() {
  ...
  flappybird = createSprite(50,height-70,20,50);
  
  
  flappybird.addImage(flappybird_img)
  flappybird.scale = 0.08;
...
function draw() {
  ...
  if (gameState===PLAY){
    ...
    if((touches.length > 0 || keyDown("SPACE")) && flappybird.y  >= height-120) {
      jumpSound.play( )
